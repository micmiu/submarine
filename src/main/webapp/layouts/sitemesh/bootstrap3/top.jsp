    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message key="menu.report"/>
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<c:url value='/data/report/index.do?method=show'/>"><fmt:message key="menu.demo"/></a></li>
                        <li><a href="#"><fmt:message key="menu.report.jm"/></a></li>
                        <li><a href="#"><fmt:message key="menu.report.crb"/></a></li>
                        <li><a href="#"><fmt:message key="menu.report.mb"/></a></li>
                    </ul>
                </li>
            </ul>
